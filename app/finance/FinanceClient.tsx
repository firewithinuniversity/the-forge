                    ...
                    return (
                      <tr key={t.id} className="border-b border-[#27272A]/50 hover:bg-[#1A1A1E]/50 transition-[background-color] animate-stagger-in" style={{ animationDelay: `${index * 30}ms` }}>
                        ...
                        <td className="py-3 px-3 text-center">
                          <ReceiptButton transactionId={t.id} saved={t.receiptSaved} />
                        </td>
                        <td className="py-3 px-3 text-center">
...
function ReceiptButton({ transactionId, saved }: { transactionId: string; saved: boolean }) {
  const router = useRouter();
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        title={saved ? "View receipt" : "Upload receipt"}
      >
        {saved ? (
          <>
      ...
      {showMenu && (
        <div
          className="absolute right-0 top-full mt-1 w-32 rounded-lg bg-[#1A1A1E] border border-[#27272A] shadow-xl z-20 py-1 animate-fade-in"
